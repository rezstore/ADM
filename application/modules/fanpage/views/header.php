	...
	<div id="menu">
		<ul class="group" id="menu_group_main">
			<li class="item first" id="one">
				<a href="<?php echo get_url('googleP/'); ?>"class="main <?php echo $g;?>">
				 <span class="outer">
			...
			<li class="item middle" id="two">
				<a href="<?php echo get_url('twitter/'); ?>" class="main <?php echo $t;?>">
				 <span class="outer">
			...
			<li class="item middle" id="seven">
				<a href="<?php echo get_url('facebook/'); ?>"class="main <?php echo $f;?>">
				 <span class="outer">
