        ...
        <form action="" method="post">
          <table width="100%" cellpadding="0" cellspacing="0" id="box-table-a" summary="Employee Pay Sheet">
           <tbody>
			...
			?>
			<tr>
			 <td width="100px">AppID</td> <td width="10px">:</td> <td><?php echo input('app_name'); ?></td>
			</tr>
			<tr>
			...
			<tr>
			 <td>FB Permissions</td> <td>:</td> <td><?php echo input('homeurl'); ?></td>
			</tr>
			<tr>
			 <td>Token</td> <td>:</td> <td><?php echo input('homeurl'); ?></td>
			</tr>
			<tr>
